...
public class DeliveryPluginManager {
    ...
    public IDeliveryPlugin getDeliveryPlugin(String delCode) {

        //Verificar si existe una entrada en el archivo para el domicilio indicado.
        String propertyName = "delivery." + delCode.toLowerCase();
