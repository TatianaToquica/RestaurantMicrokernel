...
public class GUIAgregarComponentes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_Ruta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 110, -1));
    ...
    private void btn_AgregarCompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_AgregarCompActionPerformed
        ...
        if(!(this.txt_Ruta.getText().isBlank())){
            ...
            componente.setCompImage(null);
        }

        try {
            if (serviceRest.createComponente(componente) != txt_nomComp.getText()) {
