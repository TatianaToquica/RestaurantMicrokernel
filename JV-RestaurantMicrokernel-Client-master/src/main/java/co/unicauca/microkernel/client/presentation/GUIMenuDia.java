    ...
    private void initComponents() {
        ...
        tblDataTodosComp.addMouseListener(new java.awt.event.MouseAdapter() {
            /**public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblDataTodosCompMouseClicked(evt);
            }*/
...
/**
    private void tblDataTodosCompMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataTodosCompMouseClicked
        int column = tblDataTodosComp.getColumnModel().getColumnIndexAtX(evt.getX());
        int row = 0;//evt.getY() / tblDataTodosComp.getRowHeight();
        //jLabel1.setText(column+"-"+row);
        String value = tblDataTodosComp.getValueAt(row,column).toString();
        jLabel1.setText(value);
    }//GEN-LAST:event_tblDataTodosCompMouseClicked
*/
    private void tblDataTodosCompMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataTodosCompMousePressed
        ...
        jLabel1.setText(components.get(indexFila).getCompId()+", "+cbxDias.getSelectedItem().toString());
